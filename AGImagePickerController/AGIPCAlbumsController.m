...
- (void)loadAssetsGroups
{
  ...
  dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_LOW, 0), ^{
    ...
    @autoreleasepool {
      ...
      [[AGImagePickerController defaultAssetsLibrary] enumerateGroupsWithTypes:ALAssetsGroupPhotoStream
                                                                    usingBlock:assetGroupEnumerator 
                                                                  failureBlock:assetGroupEnumberatorFailure];
      [[AGImagePickerController defaultAssetsLibrary] enumerateGroupsWithTypes:ALAssetsGroupSavedPhotos
                                                                    usingBlock:assetGroupEnumerator 
                                                                  failureBlock:assetGroupEnumberatorFailure];
      [[AGImagePickerController defaultAssetsLibrary] enumerateGroupsWithTypes:ALAssetsGroupAlbum
                                                                    usingBlock:assetGroupEnumerator 
                                                                  failureBlock:assetGroupEnumberatorFailure];
      [[AGImagePickerController defaultAssetsLibrary] enumerateGroupsWithTypes:ALAssetsGroupEvent
                                                                    usingBlock:assetGroupEnumerator 
                                                                  failureBlock:assetGroupEnumberatorFailure];
      [[AGImagePickerController defaultAssetsLibrary] enumerateGroupsWithTypes:ALAssetsGroupFaces
                                                                    usingBlock:assetGroupEnumerator 
                                                                  failureBlock:assetGroupEnumberatorFailure];
